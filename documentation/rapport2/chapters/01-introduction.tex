...
\begin{description}
  \item[Chapitre~1] Introduction générale, problématique et objectifs.
  \item[Chapitre~2] Cadre général du projet : présentation de l'organisme d'accueil (\TT{}), méthodologie Scrum et planification.
  \item[Chapitre~3] État de l'art : protocoles IoT, sécurité des flux, PKI, ML pour la détection d'anomalies.
  \item[Chapitre~4] Architecture générale du système : topologie réseau, composants, flux E2E.
  \item[Chapitre~5] Infrastructure PKI et déploiement de HashiCorp Vault.
  \item[Chapitre~6] Configuration TLS/mTLS sur le broker Mosquitto.
  \item[Chapitre~7] Simulation de la flotte IoT et injection des patterns d'attaque.
  \item[Chapitre~8] Analyse réseau avec Suricata IDS.
  \item[Chapitre~9] Intégration SIEM avec Wazuh.
  \item[Chapitre~10] Détection d'anomalies par Machine Learning.
  \item[Chapitre~11] Évaluation des performances.
  \item[Chapitre~12] Conclusion et perspectives.
\end{description}
